...
const SpecialEventsComponent = ({ mediaLink }: any) => {
  ...
  const fetchEvents = useCallback(async () => {
    ...
    try {
      ...
      const validEvents = filterExpiredContent(events, 'validTo');
      console.log('Fetched Events:', events.length, 'Valid Events:', validEvents.length);
      setSpecialEvents(validEvents);
    } catch (error) {
